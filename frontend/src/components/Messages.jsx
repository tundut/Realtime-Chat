...
const Messages = ({ conversationId }) => {
    ...
    if (!conversationId) {
        return <div className="text-gray-400">Chọn một cuộc trò chuyện</div>;
    }

    return (
        <div className="flex-grow h-full flex flex-col">
            <div className="w-full h-21 p-1 bg-purple-600 dark:bg-gray-800 shadow-md rounded-xl rounded-bl-none rounded-br-none">
            ...
            <div className="w-full flex-grow bg-gray-100 dark:bg-gray-900 my-2 p-2 overflow-y-auto">
                {messages.map((message) => {
                    ...
                    return (
                        <div
                            key={message.id} 
                            className={`flex ${isMe ? "justify-end" : "justify-start"} m-1`}
                        >
                            {!isMe && (
